...
def US21(fam, indi):
    ...
    for i in fam:
        ...
        for j in indi:
            if(j[0] == husb):
                if(j[2] == "F"):
                    husbandos.append(j[1])
            if(j[0] == wife):
                if(j[2] == "M"):
                    waifus.append(j[1])
    if(len(waifus) > 0 or len(husbandos) > 0):
        print("US21: Wrong genders for certain family members")
        print("Should be Male:")
        print(husbandos)
        print("Should be Female:")
        print(waifus)
        allofdem = husbandos + waifus
        return(allofdem)
    print("US21: All family members have correct genders")
    return ("US21: All family members have correct genders")
...
US21(families, individuals)

class testCS555Project(unittest.TestCase):

    def test1(self):
        self.assertEqual(US21(families, individuals), "US21: All family members have correct genders")
